...
`docs/README.md`, `docs/architecture.md`, `docs/design.md`, `docs/interfaces.md`, `docs/configuration.md`, `docs/data-model.md`, `docs/operations.md`, and `docs/api-examples.md` must be updated in the same change whenever behavior, boundaries, schema, or commands change. Update `README.md` as well when setup or operator workflow changes.
